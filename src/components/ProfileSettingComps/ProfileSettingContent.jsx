  ...
  return (
    <div className="flex flex-col w-full h-screen">
      ...
      <div className="px-4 overflow-y-scroll no-scrollbar">
        ...
        <div className="border border-gray-200 rounded-[4px] mt-6">
          <div className="px-5 py-3 border-b bg-[#f8f9fa]">
            <h3 className="text-[16px] leading-[1.2] font-medium text-[#495057] mb-[6px]">
              Social network profiles
            </h3>
        ...
        {/* Password */}
        <div className="border border-gray-200 rounded-[4px] mt-6 mb-5">
          <div className="px-5 py-3 border-b bg-[#f8f9fa]">
            <h3 className="text-[16px] leading-[1.2] font-medium text-[#495057] mb-[6px]">
              Password
            </h3>
          ...
          <form onSubmit={handleSubmit} className="p-5">
            <div className="grid grid-cols-1 gap-y-3 gap-x-6 sm:grid-cols-2 mb-3">
              <InputField
                ...
                onChange={(value) => handleChange("firstName", value)}
              />
              <div className="opacity-0 max-sm:hidden"></div>
              <InputField
                type={"password"}
                label="New Password"
                value={"123"}
